...
class UNetSeg(nn.Module):
    """Small U-Net for lung/heart segmentation (3 output channels: Left Lung, Right Lung, Heart).

    Same skeleton as the flow-field generator (brain-segmentation-pytorch) but outputs a
    sigmoid probability map per structure.
    """
